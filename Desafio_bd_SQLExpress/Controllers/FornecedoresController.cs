...
namespace Desafio_bd_SQLExpress.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Logo,Nome,Vertical,Link,Historico,User_creator")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Logo,Nome,Vertical,Link,Historico,User_creator")] Fornecedor fornecedor)
        {
            if (id != fornecedor.Id)
            {
                return NotFound();
